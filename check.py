...
def check(cookies, geo_api_info, id, uid):
    ...
    data = {
        ...
        # 'area': geo_api_info['addressComponent']['province'] + ' ' + geo_api_info['addressComponent']['city']+ ' ' + geo_api_info['addressComponent']['district'],
        ...
        "sfjkyc": '0',
        "gzczxq": '1',
        "zrwjtw": '1',  # 昨日晚间体温 1: (37-) 2:(37-37.2) 3:(37.3-37.5) 4:(37.5+) 3,4会无法入校
        "jrzjtw": '1', # 今日早间体温 1: (37-) 2:(37-37.2) 3:(37.3-37.5) 4:(37.5+)
        "ifcyglq": '0',
        "dqsfzgfxszqs": '0',
        "gqsfyzgfxljs": '0',
        "gqsfyqzfhryjc": '0',
        "sfyjwljqyhg": '0',
        "cjfxsfhs": '1',
        #"hsjczm": 'https%3A%2F%2Fm1.nuaa.edu.cn%2Fimage%2F764%2Ff9222ec0053a2072981d369ed944ee1b.png',
        "bzxyy": '1',
        "id": id,
        "uid": uid,
        "date": time.strftime("%Y%m%d", time.localtime()),  # 打卡年月日一共8位
